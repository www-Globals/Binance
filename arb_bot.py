...
# 🔽 LOWERED THRESHOLDS FOR TESTNET (to see trades)
PROFIT_THRESHOLD = 0.001        # 0.1% (was 0.35%)
SLIPPAGE_BUFFER = 0.001
MIN_PROFIT_KES = 5              # 5 KES (was 20)
MAX_SPREAD = 0.005              # 0.5% (was 0.2%)

# 🛡️ RISK LIMITS (unchanged)
TRADE_FRACTION = 0.05           # 5% of balance per trade
MAX_TRADE_USD = 5000            # cap per trade
MIN_TRADE_USDT = 5
