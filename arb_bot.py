...
def scan():
    ...
    print(f"[SCAN] Running scan #{scan_count+1}")
    reset_daily()
    ...
    # Check if opportunity is above threshold
    if best_tri is not None and best_profit >= PROFIT_THRESHOLD:
        ...
        # print a short message every 5 scans to show no trade
        if scan_count % 5 == 0:
