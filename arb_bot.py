...
# ---------- DEBUG: print keys (partial) ----------
print(f"[DEBUG] BINANCE_API_KEY = {BINANCE_API_KEY[:4] if BINANCE_API_KEY else 'None'}...")
print(f"[DEBUG] SUPABASE_URL = {SUPABASE_URL}")

# ---------- FORCE TESTNET (ignore env var) ----------
# Always connect to testnet to avoid geo‑block.
# To use LIVE, change the api_url to 'https://api.binance.com' and set USE_TESTNET=false.
TESTNET_URL = 'https://testnet.binance.vision/api'
print(f"[INFO] Connecting to TESTNET: {TESTNET_URL}")
client = Client(BINANCE_API_KEY, BINANCE_SECRET, api_url=TESTNET_URL)
...
if __name__ == "__main__":
    ...
    time.sleep(5)
    telegram("🚀 <b>BOT STARTED (TESTNET)</b>")
