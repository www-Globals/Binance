...
def execute_trade(a, b, c, trade_amount_usd, gross_spread, legs):
    ...
    try:
        ...
        log_to_supabase({
            ...
            "balance": end_balance,              # match dashboard column name
            "trade_size_80pct": trade_amount_usd,
            "pair": pair,                        # match dashboard column name
            "gross_spread": gross_spread,
            "profit_kes": profit_kes,            # dashboard expects profit_kes
...
if __name__ == "__main__":
    load_markets()
    if VALID_TRIANGLES:
        # Log a startup row with the initial balance
